...
import tech.gonzo.filmlist.ui.viewholders.FilmListViewHolder
import tech.gonzo.filmlist.ui.viewholders.FilmViewHolder

/**
 * RecyclerView Adapter used in the MainFragment saved films list.
 *
 * Created by Gonny on 21/3/2017.
 *
 * @param listener The adapter listener.
 */
class SavedFilmAdapter(val listener: OnFilmSelectedListener) : FilmAdapter() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FilmViewHolder {
        ...
        // Inflate layout.
        val view = inflater.inflate(R.layout.row_item_main, parent, false)

        // Return a FilmListViewHolder with the inflated layout.
        return FilmListViewHolder(view, listener)
    }
    ...
    override fun onBindViewHolder(holder: FilmViewHolder, position: Int) {
        ...
        (holder as FilmListViewHolder).bindView(list[position] as Film)
    }
}